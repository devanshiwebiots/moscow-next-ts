...
export const widgetscardchart1: ApexOptions = {
  chart: {
    toolbar: {
      show: false,
    },
...
export const widgetscardchart2: ApexOptions = {
  chart: {
    toolbar: {
      show: false,
    },
...
export const widgetscardchart3: ApexOptions = {
  chart: {
    toolbar: {
      show: false,
    },
...
export const optionscolumnchart: ApexOptions = {
  ...
  colors: ["var(--theme-secondary)", "#51bb25", "var(--theme-default)"],
  fill: {
    type: "gradient",
    gradient: {
      shade: "light",
      ...
      opacityTo: 0.9,
      stops: [0, 100],
      gradientToColors: ["var(--theme-secondary)", "#51bb25", "var(--theme-default)"],
    },
  },
  tooltip: {
    y: {
...
export const optionsCircle: ApexOptions = {
  chart: {
    type: "radialBar",
    height: 355,
    offsetY: 10,
...
export const optionsProgress1: ApexOptions = {
  chart: {
    height: 70,
    type: "bar",
    stacked: true,
...
export const optionsProgress2: ApexOptions = {
  chart: {
    height: 70,
    type: "bar",
    stacked: true,
...
export const optionsProgress3: ApexOptions = {
  chart: {
    height: 70,
    type: "bar",
    stacked: true,
...
export const optionsProgress4: ApexOptions = {
  chart: {
    height: 70,
    type: "bar",
    stacked: true,
...
export const optionsProgress5: ApexOptions = {
  chart: {
    height: 70,
    type: "bar",
    stacked: true,
...
export const optionsturnoverchart: ApexOptions = {
  chart: {
    toolbar: {
      show: false,
    },
...
export const optionscandlestickchart: ApexOptions = {
  ...
  plotOptions: {
    candlestick: {
      colors: {
        upward: "var(--theme-default)",
        downward: "var(--theme-secondary)",
      },
    },
  },
  legend: {
...
export var optionsuserchart:ApexOptions = {
  chart: {
    toolbar: {
      show: false,
    },
  ...
  colors: [
    "var(--theme-default)", "var(--theme-secondary)",
    "#51bb25",
    "#544fff",
  ],
  title: {
