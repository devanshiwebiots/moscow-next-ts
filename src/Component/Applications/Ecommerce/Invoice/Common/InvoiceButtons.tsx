...
export const InvoiceButtons: React.FC<InvoicePrintType> = ({ handlePrint }) => {
  ...
  return (
    <span style={{display: "flex",justifyContent: "center",gap: 15,}} className="pb-5">
      ...
      <Link style={{background: "rgba(26, 95, 127, 0.19)",color: "var(--theme-default)",borderRadius: 10,padding: "18px 27px",fontSize: 16,fontWeight: 600,outline: 0,border: 0,textDecoration: "none",}} href={`/ecommerce/product`} download>
        {Cancel}
        <i className="icon-arrow-right" style={{fontSize: 13,fontWeight: "bold",marginLeft: 10,}}/>
      </Link>
    </span>
