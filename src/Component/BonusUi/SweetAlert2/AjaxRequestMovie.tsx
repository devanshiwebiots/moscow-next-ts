...
const AjaxRequestMovie = () => {
  const displayAlert = () => {
    SweetAlert.fire({text: 'Search for a movie. e.g. "Herry Poter".',input: "text",confirmButtonColor: "var(--theme-default)",})
      .then((name) => {
      ...
      .then((json) => {
        ...
        if (!movie) return SweetAlert.fire({ text: "No movie was found!", confirmButtonColor: "var(--theme-default)" });
