...
import { Href, IOTDeveloper, JustifyTab, MoscowProfilesForNewEmployees, UxDesigner, WebDesigner } from "@/Constant";
      ...
      <Card>
        ...
        <CardBody>
          <CardHeader className="d-flex justify-content-between align-items-center flex-wrap gap-2 pb-2 p-0">
            <p><em className="txt-danger">{MoscowProfilesForNewEmployees}</em></p>
