            ...
            <Range
              ...
              renderTrack={({ props, children }) => (
                <div onMouseDown={props.onMouseDown} onTouchStart={props.onTouchStart} style={{ ...props.style, height: "36px" }} className='d-flex w-100'>
                  <output className='mt-2 mx-2'>0.00</output>
                  ...
                  <output className='mt-2 mx-2'>20.00</output>
                </div>
              )}
              renderThumb={({ props }) => {
                ...
                return (
                  <div key={key} {...prop} className='d-flex justify-content-center align-items-center rounded-5' style={{ ...prop.style, height: "20px", width: "20px", backgroundColor: "#4AAD8A", boxShadow: "0px 2px 6px #AAA" }}>
