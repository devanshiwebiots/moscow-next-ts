...
import { AgreeToTermsAndConditions, MoscowMail, ConfirmPassword, Email, EnterConfirmPassword, EnterPassword, EnterYourName, FirstName, Password } from "@/Constant";
      ...
      <Row>
        <Col sm="6">
          <FormGroup>
            ...
            <Input onChange={getUserData} value={email} name="email" type="email" placeholder={MoscowMail} />
          </FormGroup>
        </Col>
        <Col sm="6">
          <FormGroup>
