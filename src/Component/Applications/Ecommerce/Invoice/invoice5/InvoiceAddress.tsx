...
const InvoiceAddress = () => {
  return (
    <td>
      <span style={{ fontSize: 16, display: "block", fontWeight: 600, color: "rgba(26, 95, 127, 1)", marginBottom: 14 }} >{InvoiceTo} :</span>
      <span style={{ fontSize: 16, display: "block", fontWeight: 600, color: "rgba(26, 95, 127, 1)", marginBottom: 8 }} >Brooklyn Simmons</span>
