...
const InvoiceOrderHeader = () => {
  return (
    <tr style={{background: "#1a5f7f",borderRadius: "5.47059px",overflow: "hidden",boxShadow: "0px 10.9412px 10.9412px rgba(82, 77, 141, 0.04), 0px 9.51387px 7.6111px rgba(82, 77, 141, 0.06), 0px 5.05275px 4.0422px rgba(82, 77, 141, 0.0484671)",}}>
