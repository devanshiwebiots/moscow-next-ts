            ...
            <Range
              ...
              renderTrack={({ props, children }) => (
                <div onMouseDown={props.onMouseDown} onTouchStart={props.onTouchStart} style={{ ...props.style, height: "30px" }} className='d-flex w-100'>
                  <output className='mt-2 mx-2'>-20</output>
                  ...
                  <output className='mt-2 mx-2'>0</output>
                </div>
              )}
              renderThumb={({ props }) => {
                ...
                return (
                  <div key={key} {...prop} className='d-flex justify-content-center align-items-center rounded-5' style={{ ...prop.style, height: "20px", width: "20px", border: "3px solid #9560DD", backgroundColor: "#9560DD", boxShadow: "0px 2px 6px #AAA" }}>
