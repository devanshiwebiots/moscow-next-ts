  ...
  return (
    <ul style={{ padding: 0, margin: 0, listStyle: "none" }}>
      ...
      <li style={{ display: "flex", alignItems: "center" }}>
        ...
        <span style={{ display: "block",color: "var(--theme-default)", opacity: "0.9", fontWeight: 600, padding: "12px 25px", borderRadius: 5, background: "rgba(26, 95, 127, 0.19)", fontSize: 16}} >$6120.00</span>
      </li>
    </ul>
  );
};
