...
import { MoscowMail, ConfirmPassword, Email, EnterConfirmPassword, EnterPassword, EnterYourName, Name, Password } from "@/Constant";
  ...
  return (
    <Row className="g-3">
      ...
      <Col sm="6">
        ...
        <Input name="email" onChange={getUserData} value={email} type="email" placeholder={MoscowMail} />
      </Col>
      <Col xs="12">
