          ...
          <div className='d-flex justify-content-center flex-wrap m-3'>
            <Range
              ...
              renderThumb={({ props, isDragged }) => {
                ...
                return (
                  <div key={key} {...prop} className='d-flex justify-content-center align-items-center rounded-5' style={{ ...prop.style, height: "35px", width: "35px", backgroundColor: "#FFF", boxShadow: "0px 2px 6px #AAA" }}>
