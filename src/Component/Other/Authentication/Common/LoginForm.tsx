    ...
    <div>
      <div>
        <Link className={`logo ${logoClass ? logoClass : ""}`} href={`/dashboard/default_dashboard`}>
          ...
          <img className="img-fluid for-dark m-auto" src={`${ImagePath}/logo/logo_dark.png`} alt="looginpage" />
        </Link>
      </div>
          ...
          {() => (
            <Form className="theme-form">
              ...
              <FormGroup className="mb-0">
                <Label className="col-form-label mb-0">{EmailAddressLogIn}</Label>
              ...
              <FormGroup className="mb-0">
                <Label className="col-form-label mb-0">{Password}</Label>
