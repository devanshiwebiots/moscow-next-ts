          ...
          <Range
            ...
            renderTrack={({ props, children }) => (
              <div onMouseDown={props.onMouseDown} onTouchStart={props.onTouchStart} style={{ ...props.style, height: "36px" }} className='d-flex w-100 mt-2 mb-3'>
                <output className='mt-2 mx-2'>{values[0]}</output>
                ...
                <output className='mt-2 mx-2'>{values[1]}</output>
              </div>
            )}
            renderThumb={({ props }) => {
              ...
              return (
                <div key={key} {...prop} className='d-flex justify-content-center align-items-center' style={{ ...prop.style, height: "25px", width: "7px", backgroundColor: "#feb858", boxShadow: "0px 2px 6px #AAA" }}>
