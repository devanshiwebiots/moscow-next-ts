      ...
      <Table className="table-responsive" style={{ width: "100%" }} borderless>
        <tbody>
          <tr style={{ padding: "28px 0 5px", display: "flex", justifyContent: "space-between" }} >
            <td>
              <h4 style={{ fontSize: 42, fontWeight: 600, color: "var(--theme-default)", margin: 0 }} >{Invoices}</h4>
              <ul style={{ listStyle: "none", display: "flex", gap: 15, padding: 0, margin: "20px 0" }}>
                ...
                <li>
                  <span style={{ fontWeight: 600, fontSize: 16, color: "var(--theme-default)",display: "block",marginBottom: 8 }}>Brooklyn Simmons</span>
